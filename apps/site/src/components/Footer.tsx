...
export const Footer = () => {
  return (
    <footer className="py-10 px-4 md:px-16 lg:px-32 dark:bg-slate-950 border-t-2 border-gray-200 dark:border-gray-800 mt-10">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between">
          <div className="grid grid-cols-1 md:flex md:justify-between md:space-x-10">
            <div>
              <h5 className="text-lg font-semibold mb-4 dark:text-gray-300">Resources</h5>
          ...
          <div className="flex flex-col space-y-4 items-end md:block">
        ...
        <div className="text-center mt-10">
          <p className="text-sm text-gray-600">
            © {new Date().getFullYear()} The Sanity Times. All rights reserved.
          </p>
          <p className="text-sm text-gray-600">
            Powered by{' '}
          ...
          <div className="flex space-x-4 justify-center my-6 md:hidden">
            <SocialLinks />
          </div>
        </div>
      </div>
